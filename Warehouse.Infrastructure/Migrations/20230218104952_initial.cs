        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OutcomeDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Title = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Outcomes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_ReadyProducts_ReadyProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadyProductWarehouses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadyProductWarehouses_ReadyProducts_ReadyProductId",
                        column: x => x.ReadyProductId,
                        principalTable: "ReadyProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipes_ReadyProducts_ReadyProductId",
                        column: x => x.ReadyProductId,
                        principalTable: "ReadyProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OutcomeItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnotherExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnotherExpenses_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialExpenses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialExpenses_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialExpenses_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnotherExpenses_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomeItems_MaterialId",
                table: "IncomeItems",
                column: "MaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialExpenses_MaterialId",
                table: "MaterialExpenses",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialExpenses_OrderId",
                table: "MaterialExpenses",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialExpenses_UserId",
                table: "MaterialExpenses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutcomeItems_MaterialId",
                table: "OutcomeItems",
                column: "MaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadyProductWarehouses_ReadyProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_ReadyProductId",
                table: "Recipes",
                column: "ReadyProductId");
        }
